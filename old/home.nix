...

{
  ...
  services.sxhkd = {
    ...
    keybindings = {
      ...
      "alt + q" = "dmenu_run -nb '#ffffff' -nf '#000000' -sb '#999999' -fn 'JetBrains Mono NL:style=Regular:size=12'";
      "alt + b" = "librewolf";
      "alt + semicolon" = "notify-send \"$(date)\"";
      ...
      # Second monitor
      "alt + {_,shift + } h" = "bspc {desktop -f,node -d} '^1:^1'";
      "alt + {_,shift + } j" = "bspc {desktop -f,node -d} '^1:^2'";
      "alt + {_,shift + } k" = "bspc {desktop -f,node -d} '^1:^3'";
      "alt + {_,shift + } l" = "bspc {desktop -f,node -d} '^1:^4'";
      ...
      "XF86MonBrightness{Up,Down}" = "light -{A,U} 3";
  ...
  xsession.initExtra = ''
    if xrandr | grep -q "HDMI1 connected"; then
      # echo "Xft.dpi: 150" | xrdb
      # xrandr --output HDMI1 --off

      xrandr --output HDMI1 --primary --mode 2200x1650 --output eDP1 --off --left-of HDMI1
      echo "Xft.dpi: 200 Xcursor.size: 32" | xrdb
    else
      echo "Xft.dpi: 150" | xrdb
    fi
